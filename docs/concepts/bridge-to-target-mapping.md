...
- forward-looking docs use target product names directly, even when a slice has
  bounded coverage
- bridge or output annotation detail is not canonical `ClaimSet` meaning; if
