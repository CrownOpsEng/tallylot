...
| `tests/pipeline/test_intake_sort.py` | `ported` | `tests/unit/application/services/intake/test_apply_workflow.py`, `tests/unit/application/services/intake/test_plan_package_review_workflow.py`, `tests/unit/application/services/intake/test_plan_routing_workflow.py`, `tests/unit/application/services/intake/packages/test_cycles.py`, `tests/unit/application/services/intake/packages/test_duplicates.py`, `tests/unit/application/services/intake/packages/test_isolation.py`, `tests/unit/application/services/intake/packages/test_merges.py`, `tests/unit/application/services/intake/packages/test_scope_conflicts.py`, `tests/unit/application/services/intake/packages/test_scope_precedence.py` |
...
| `tests/unit/test_package_resolution.py` | `covered` | `tests/unit/application/services/intake/packages/test_cycles.py`, `tests/unit/application/services/intake/packages/test_duplicates.py`, `tests/unit/application/services/intake/packages/test_helpers.py`, `tests/unit/application/services/intake/packages/test_isolation.py`, `tests/unit/application/services/intake/packages/test_merges.py`, `tests/unit/application/services/intake/packages/test_scope_conflicts.py`, `tests/unit/application/services/intake/packages/test_scope_precedence.py`, `tests/unit/application/services/intake/test_plan_package_review_workflow.py` |
