...
| `tests/pipeline/test_intake_sort.py` | 17 | `tests/unit/application/services/intake/test_apply_workflow.py`; `tests/unit/application/services/intake/test_plan_package_review_workflow.py`; `tests/unit/application/services/intake/test_plan_routing_workflow.py`; `tests/unit/application/services/intake/test_package_cycles.py`; `tests/unit/application/services/intake/test_package_duplicates.py`; `tests/unit/application/services/intake/test_package_isolation.py`; `tests/unit/application/services/intake/test_package_merges.py`; `tests/unit/application/services/intake/test_package_scope_conflicts.py`; `tests/unit/application/services/intake/test_package_scope_precedence.py` | `ported-direct` | Legacy sort and grouping rules now live in typed intake planning and package-resolution seams under the dedicated intake package |
...
| `tests/unit/test_package_resolution.py` | 23 | `tests/unit/application/services/intake/test_package_cycles.py`; `tests/unit/application/services/intake/test_package_duplicates.py`; `tests/unit/application/services/intake/test_package_helpers.py`; `tests/unit/application/services/intake/test_package_isolation.py`; `tests/unit/application/services/intake/test_package_merges.py`; `tests/unit/application/services/intake/test_package_scope_conflicts.py`; `tests/unit/application/services/intake/test_package_scope_precedence.py`; `tests/unit/application/services/intake/test_plan_package_review_workflow.py` | `ported-direct` | Same-cycle merges, mixed-cycle review, scope conflicts, subset elimination, and overlap decisions are directly covered inside the intake feature package |
