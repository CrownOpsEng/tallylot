...
Use this folder for the current implemented runtime, operator workflow, and
artifact handling.
...
on them for round close. Do not use this folder for forward planning or design
decisions.
