...
from tallylot.adapters.sources.wallets.ledger_live.translation import (
    translate_operations,
)
from tallylot.adapters.sources.wallets.ledger_live.wallets import (
    HEADER_FIELDS,
...
class _LedgerLiveAdapter:
    ...
    def match_intake(self, relative_path: str, facts: IntakeFileFacts) -> int:
        return match_intake_by_path_or_header(
            relative_path, facts, path_hints=("ledger",)
        )
    ...
    def translate(
        ...
        drafts, issues, reviews = translate_operations(profile, raw_dir)
