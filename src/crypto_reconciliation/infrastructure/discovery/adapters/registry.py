...
def build_registry() -> AdapterRegistry:
    source_adapters = collect_source_adapters("crypto_reconciliation.adapters.sources")
    output_adapters = collect_output_adapters("crypto_reconciliation.adapters.outputs")
