...
| Reconciliation, checkpoint, journal, tax-engine implementation, or target pipeline products | `docs/concepts/reconciliation-tax-architecture.md`, `docs/reference/target-ids-and-refs.md`, `docs/reference/target-persistence-reference.md`, `ROADMAP.md`, `docs/status/migration-sequence.md`, `docs/concepts/oracle-boundaries.md`, `docs/concepts/transaction-classification.md`, `docs/standards/engineering.md` |
...
- Planning and forward-looking docs may use roadmap-owned ephemeral tags when
  ...
  metadata, branch names, code, tooling, tests, filenames, and generated
  durable examples must stay phase-free and roadmap-free.
