...
def test_pdf_balance_extraction_service_extracts_supported_statement_rows(
    tmp_path: Path,
) -> None:
    ...
    pdf.drawString(
        72, 735, "Portfolio summary balances are as of 2025-12-31 23:59:59 UTC"
    )
    ...
    response = ExtractPdfBalancesUseCase(
