...
def test_apply_package_rules_accumulates_related_overlap_bundles_across_three_packages() -> (
    None
):
    items = [
        package_item(
    ...
    related = {
        item.bundle_id: item.package_related_bundles
...
def test_apply_package_rules_prefers_content_scope_over_conflicting_path_labels() -> (
    None
):
    items = [
        package_item(
