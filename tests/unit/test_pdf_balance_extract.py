...
def test_binance_balance_rows_from_text_extracts_total_and_wallets() -> None:
    text = """
...
def test_shakepay_balance_rows_from_text_extracts_open_and_close() -> None:
    text = """
...
def test_detect_extractor_picks_known_filename_patterns() -> None:
